...
struct Block {
    ...
    pub range: Atomic<ConditionRange>,
    ...
    pub left_parent: Atomic<Option<&'static Block>>,
    ...
    pub right_parent: Atomic<Option<&'static Block>>,
...
impl Block {
    ...
    pub fn token_footer(&self) -> &TokenBlockFooter {
    ...
    pub fn branch_footer(&self) -> &BranchBlockFooter {
        // SAFETY: All of the `footer` variants have the same field layout, so this is safe
        // regardless of the actual type of the block.
